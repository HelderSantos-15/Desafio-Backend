...
async function editProduto(id) {
  ...
  const { value: formValues } = await Swal.fire({
    ...
    html: `
      ...
      <input id="swal-preco" class="swal2-input" placeholder="Preço" type="number" value="${produto.preco}">
      <input id="swal-quantidade" class="swal2-input" placeholder="Quantidade" type="number" value="${produto.quantidade}">
    `,
    focusConfirm: false,
    preConfirm: () => {
      return {
